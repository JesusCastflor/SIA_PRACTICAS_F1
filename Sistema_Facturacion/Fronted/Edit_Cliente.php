                        ...
                        <div aria-labelledby="exampleModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <?php
                                   $result = mysqli_query($mysqli, "SELECT * FROM mae_cliente WHERE ID_Cliente = '$id'");
                                   while ($row = mysqli_fetch_array($result)) {
                                       echo "<input type='hidden' name='id' value='{$row['ID_Cliente']}' required>";
                                       ...
                                       echo "</div>";
                                       echo "<div class='form-group'>";
                                       echo "<label for='Id_cliente' class='col-form-label'>N. Documento :</label>";
                                       echo "<input type='text' class='form-control' placeholder='' name='ID_Cliente' value='{$row['ID_Cliente']}' required>";
                                       echo "</div>";
                                       echo "<div class='form-group'>";
                                       echo "<label for='Nombre_cliente' class='col-form-label'>Nombres y Apellidos :</label>";
                                       echo "<input type='text' class='form-control' placeholder='' name='Nombres_Apellidos' value='{$row['Nombres_Apellidos']}' required>";
                                       echo "</div>";
                                       echo "<div class='form-group'>";
                                       echo "<label for='Email' class='col-form-label'>Email :</label>";
                                       echo "<input type='text' class='form-control' placeholder='' name='Email' value='{$row['Email']}' required>";
                                       echo "</div>";
                                       echo "<div class='form-group'>";
                                       echo "<label for='Telefono' class='col-form-label'>Telefono :</label>";
                                       ...
                                       echo "<input type='text' class='form-control' placeholder='' name='Direccion' value='{$row['Direccion']}' required>";
                                       echo "</div>";
                                       echo "</div>";
